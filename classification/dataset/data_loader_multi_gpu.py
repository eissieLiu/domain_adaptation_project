...
class data_loader_multi_gpu:
    ...
    def get_data_loader(self,trainset,testset):
        ...
        train_loader = torch.utils.data.DataLoader(trainset, batch_size=self.args.batch_size, shuffle=True,num_workers=self.args.num_workers,sampler=self.get_sampler(trainset))
        test_loader = torch.utils.data.DataLoader(testset, batch_size=self.args.batch_size, shuffle=True,num_workers=self.args.num_workers,sampler=self.get_sampler(testset))
